...
This application receives the outgoing IP address, application UIDs to extract the app-specific information alongside other useful data in the form of a PCAP file via a local TCP Server from PCAPdroid and subsequently transmits an inquiry to AbuseIPDB to evaluate the maliciousness of outbound traffic.
