...
As shown in the following code snippet provided on Android \emph{developer website}\footnote{\url{https://developer.Android.com/develop/connectivity/vpn}}, Android system establishes a TUN (Tunnel) interface to route all the packets utilizing a VpnService builder and routes them though the localhost address.
