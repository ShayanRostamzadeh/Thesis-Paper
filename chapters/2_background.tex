...
As shown in the following code snippet provided on android \href{https://developer.android.com/develop/connectivity/vpn}{\emph{developer website}}, android system establishes a TUN (Tunnel) interface to route all the packets utilizing a VpnService builder and routes them though the localhost address.
