...
\begin{enumerate}
	...
	\item Go back to the Monitor page and start the server by clicking the corresponding button located in the middle of the page as shown in \cref{fig:Monitor_Page}. The server then becomes active (background colour turns to green) and starts listening on the specified port in the user preferences.
